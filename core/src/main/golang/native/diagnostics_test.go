...
func TestDiagnosticsConfigurationIsUnavailableWithoutBuildFingerprint(t *testing.T) {
	...
	if _, err := newDiagnosticsConfiguration("https://example.com", "user:password", 19091); !errors.Is(err, errDiagnosticsFingerprintMissing) {
...
func TestDiagnosticsStatusReportsFailureWithoutInternalDetails(t *testing.T) {
	...
	diagnosticsStart("https://example.com", "user:password", "controller-secret", 19091)
