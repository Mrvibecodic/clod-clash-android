...
private val MIGRATION_8_9 = object : Migration(8, 9) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE imported ADD COLUMN nameManual INTEGER NOT NULL DEFAULT 0")
        database.execSQL("ALTER TABLE pending ADD COLUMN nameManual INTEGER NOT NULL DEFAULT 0")
    }
}
